        ...
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              ...
              <p class="mb-0">Avenida Oriente 7 #113, Tecamachalco, Puebla>
              <img src="images/qr1.jpeg" alt="Image" class="img-fluid">
              <h2 class="h5 mb-5  text-center text-black">¡Escanéame! si deseas contactar a un administrador</h2>
            </div>
          </div>
        </div>
      </div>
